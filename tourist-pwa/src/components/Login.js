    ...
    return (
      <div className={`login-screen theme-${theme}`}> 
        <div className="login-shell">
          <div className="login-brand-block redesign-login-avatar">
            <img src="/logo192.png" alt="App Logo" className="login-avatar" />
          ...
          <form className="login-card redesign-login-card" onSubmit={handleLoginSubmit} noValidate>
            <header className="login-card-header">
              <h1>Sign in</h1>
              <p>Enter your registered email address to receive a secure OTP.</p>
            </header>
            ...
            <button
              className="login-primary redesign-login-btn"
    ...
    return (
      <div className={`login-screen theme-${theme}`}> 
        <div className="login-shell">
          ...
          <form className="login-card redesign-login-card" onSubmit={handleOtpSubmit} noValidate>
            <header className="login-card-header">
              <h1>Enter OTP</h1>
            ...
            <button className="login-primary redesign-login-btn" disabled={!otp.trim()} type="submit">
              Login
            </button>
